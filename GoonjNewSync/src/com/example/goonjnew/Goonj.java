...
{	
	...
	{		
	    ...
	    GlobalData.dh = new Helper(this,1);
    ...
    {  
        ...
        {          	   
    		...
    		if(currentFile != "")
    		{
				...
				dh.puttoRepository("Connect.Sathyam.Audio", destPath,"mridu");
    	...
    	{	    	
	        ...
	        {  
	    		dh.puttoRepository("Connect.Sathyam.Photo", currentFile,"mridu");
	        ...
	        {  
				...
				dh.puttoRepository("Connect.Sathyam.Video", destPath, "mridu");
