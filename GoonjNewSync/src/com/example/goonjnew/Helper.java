...
public class Helper {
	...
	public Helper(Context context,int userid) {
	...
	public void printSingleRecord(Record r)
	{
	...
	public Object getObject(String className) {        
	 ...
	 public Object getObject(String className, ArrayList<Record> records) {        
	    ...
	    {
	    	System.out.println(r.datatype + " " + r.groupid + " " + r.key);
	    }
	public void putToRepository(Record[] records)
	{
		...
		{
			insert(0,groupid,records[i].key, records[i].value, user, records[i].datatype, timestamp, " ");				   
		}
